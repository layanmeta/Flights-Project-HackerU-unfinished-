...
{
    class LoggedInAirlineFacade : AnonymousUserFacade, ILoggedInAdministratorFacade
    {
        ...
        public void UpdateAirlineDetails(LoginToken<Administrators> token, AirlineCompany customer)
        {
            throw new NotImplementedException();
        }
